...
You can pass them on the command line or put them in `.env` file which will be loaded at startup (see [.env.default](https://github.com/Radrw/auth-starter/blob/master/.env.default) for an example).
