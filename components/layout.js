    ...
    return (
      <React.Fragment>
        <Head>
          ...
          <title>{this.props.title || 'Starter Project'}</title>
        ...
        <Container fluid={this.props.fluid}>
          ...
          <p className="text-muted small">
            <Link href="https://github.com/Radrw/auth-starter"><a className="text-muted font-weight-bold"><span className="icon ion-logo-github"/> {Package.name} {Package.version}</a></Link>
            .
